...
callback_api_1.default.connect("amqps://pgzzbmfy:qtm1vCdG-NW7YSwlH9I0VJE8cQWiqs2o@puffin.rmq2.cloudamqp.com/pgzzbmfy", function (error, connection) {
    if (error)
    ...
    connection.createChannel(function (error, channel) {
        ...
        app.post("/api/products", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductModel_1.default.create(__assign({}, req.body))];
                    case 1:
                        product = _a.sent();
        ...
        app.get("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductModel_1.default.findById(req.params.id)];
                    case 1:
                        product = _a.sent();
        ...
        app.put("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductModel_1.default.findByIdAndUpdate(req.params.id, __assign({}, req.body))];
                    case 1:
                        product = _a.sent();
        ...
        app.delete("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductModel_1.default.findByIdAndDelete(req.params.id)];
                    case 1:
                        product = _a.sent();
